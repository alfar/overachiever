...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { description: @achievement.description, name: @achievement.name, notes: @achievement.notes, website: @achievement.website }
    end
  ...
  test "should update achievement" do
    put :update, id: @achievement, achievement: { description: @achievement.description, name: @achievement.name, notes: @achievement.notes, website: @achievement.website }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
